  ...
  const experiences = [
    {
      ...
      points: [
        'Engineered responsive user interfaces for JasExpress, a prominent logistics and cargo shipping platform.',
        'Implemented modern React.js and Tailwind CSS architectures to deliver lightning-fast interactive web experiences.',
        'Collaborated on modular, accessible UI components optimized for performance and enhanced user engagement.',
        'Ensured cross-browser consistency and pixel-perfect responsiveness across all screen breakpoints.',
      ],
